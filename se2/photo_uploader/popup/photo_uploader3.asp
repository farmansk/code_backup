...
function PROGRESS() {
   ...
   var form = document.editor_upimage ;
   ...
   if ( form.Filedata.value.indexOf(".jpg") != -1 || form.Filedata.value.indexOf(".JPG") != -1 || form.Filedata.value.indexOf(".gif") != -1 || form.Filedata.value.indexOf(".GIF") != -1 || form.Filedata.value.indexOf(".png") != -1 || form.Filedata.value.indexOf(".PNG") != -1 ) {
   }
   else {
   
    alert("지원하지 않는 파일입니다.(지원가능한 파일형식 - jpg/gif/png)") ;
    return ;
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="file_uploader3.asp" method="post" enctype="multipart/form-data">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
	          <a href="javascript:PROGRESS()"><img src="../../img/photoQuickPopup/btn_confirm2.png" width="49" height="28" alt="확인"></a>
            <a href="javascript:self.close();"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
