...
if ( window.innerWidth > 991 ) {
  ...
  document.writeln("<div id='left_box' class='web'>");
   ...
   <div style="border:1px #E5E5E5 solid;padding:15px;font-size:13pt;font-weight:500;text-align:center"><div style="display:inline-block;text-align:right;width:20%"></div><div style="display:inline-block;text-align:center;width:55%;cursor:pointer;color:#A61313;" onclick="location.href='customer_support.php';">지원받기</div><div style="display:inline-block;text-align:right;width:20%"><img src="./img/arrow_up.png" style="margin-top:-4px;height:10px;"></div></div>
   ...
   <div class="checkout__form" style="text-align:center">
    ...
    <div class="col-lg-12 col-md-6">
     ...
     <div class="checkout__input">
      ...
      <a href="<?=$contactus_url?>" target="_blank" style="color:#262626"><?=$contactus_url?></a>
     </div>
               
     <div class="checkout__input" style="margin-top:30px">
      <p style="font-weight:500">문의메일<span>*</span></p>
      <a href="mailto:<?=$contactus_email?>" target="_blank" style="color:#262626"><?=$contactus_email?></a>
     </div>
     
               
     <div class="checkout__input" style="margin-top:30px;color:#262626">
