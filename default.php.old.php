       ...
       <CENTER>
        ...
        <div style="width:549px;border:2px #B0B1B3 solid;border-radius:10px;background:#FFFFFF">
         ...
         <div style="padding:30px;text-align:left">
          ...
          <div style="vertical-align:top;display:inline-block;width:15%;text-align:center;color:#A61313;border-bottom:5px #A61313 solid;font-size:15pt;font-weight:500">로그인<div style="height:10px"></div></div>
          ...
          <div class="checkout__input" style="margin-top:20px">
           <p>이메일</p>
           <input id="UserEmail" name="UserEmail" type="text" placeholder="이메일을 입력하세요." value="">
          </div>
          ...
          <div style="text-align:center;margin-top:10px">
           회원이 아니신가요?&nbsp;&nbsp;<div style="color:#A61313;display:inline-block;font-weight:500;cursor:pointer" onclick="location.href='./join.php'">회원가입</div>
          </div>
