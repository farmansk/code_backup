...
<?
  ...
  if($count > 0){
   ...
   ?>
          ...
          <tr>
           <th style="border-right:1px solid #E5E5E5;border-bottom:1px solid #E5E5E5;font-size:11pt;padding:5px;text-align:center;font-weight:500"><?=$rs["num"]?></th>
           <th style="border-right:1px solid #E5E5E5;border-bottom:1px solid #E5E5E5;font-size:11pt;padding:5px;text-align:left;font-weight:500"><a href="./notice_view.php?seqno=<?=$rs["seqno"]?>&intNowPage=<?=$intNowPage?>" style="color:#262626;font-weight:500"><?=$rs["title"]?></a></th>
           <th style="border-right:1px solid #E5E5E5;border-bottom:1px solid #E5E5E5;font-size:11pt;padding:5px;text-align:center;font-weight:500"><?=$rs["regdate"]?></th>
           <th style="border-right:1px solid #E5E5E5;border-bottom:1px solid #E5E5E5;font-size:11pt;padding:5px;text-align:center;font-weight:500"><?=$rs["ReadCnt"]?></th>
          </tr>
