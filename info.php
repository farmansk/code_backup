...
if ( window.innerWidth > 991 ) {
  ...
  document.writeln("<div id='left_box' class='web'>");
   ...
   <div style="border:1px #E5E5E5 solid;padding:15px;font-size:13pt;font-weight:500;text-align:center"><div style="display:inline-block;text-align:right;width:20%"></div><div style="display:inline-block;text-align:center;width:55%;color:#A61313;cursor:pointer" onclick="location.href='info.php';">비밀번호 변경</div><div style="display:inline-block;text-align:right;width:20%"><img src="./img/arrow_up.png" style="margin-top:-4px;height:10px;"></div></div>
...
if ( window.innerWidth > 991 ) {
  ...
  document.writeln("<div id='right_box' style='margin-top:30px;background:#FFFFFF;width:100%;display:inline-block;border:2px #B0B1B3 solid;border-radius:10px;padding:30px'>");
   ...
   <div style="margin-top:15px;text-align:left;font-size:13pt;font-weight:500"><img src="./img/one.png" style="height:10px;margin-top:-2px">&nbsp;&nbsp;주기적인 비밀번호 변경을 통해 개인정보를 안전하게 보호하세요.</div>
 ...
 async function SAVE(){
    ...
    if ( document.getElementById("UserPwd").value != document.getElementById("UserPwdCnfm").value ) {
     ...
     return;
       ...
       fetch("./info_save.php", requestOptions)
