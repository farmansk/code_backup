   ...
   <div style="margin-top:15px;margin-bottom:30px;border:1px #E5E5E5 solid;"></div>
            ...
            <div class="checkout__form" style="text-align:left">
                ...
                <form name="Form" method="POST">
                 ...
                 <input name="menuseqno" type="hidden" value="<?=$menuseqno?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-6">
                            ...
                            <div class="checkout__input">
                             ...
                             <input id="title" name="title" type="text" placeholder="제목" value="" style="margin-left:15px;width:90%">
                            </div>
                            
                            <div class="checkout__input" style="margin-top:20px">
                            
                             <textarea id="cont" name="cont" style="height:500px"></textarea>
...
<script>
 ...
 async function SAVE(){
    ...
    oEditors.getById["cont"].exec("UPDATE_CONTENTS_FIELD", []);	// 에디터의 내용이 textarea에 적용됩니다.
       ...
       fetch("./notice_write_save.php", requestOptions)
